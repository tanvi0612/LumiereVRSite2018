	      ...
	      <ol>
			...
			<li>  Intellectual Property Rights.
				<p>
					...
					Terms, LumiereVR and/or its licensors own all rights to the intellectual property and material
	      	...
	      	<li>  Restrictions.
	      		<p>
	      			...
	      			<ol>
	      				<li className= "no-bold"> publishing any Website material in any media; </li>
	      				<li className= "no-bold"> selling, sublicensing and/or otherwise commercializing any Website material; </li>
	      				<li className= "no-bold"> publicly performing and/or showing any Website material; </li>
	      				<li className= "no-bold"> using this Website in any way that is, or may be, damaging to this Website; </li>
	      				<li className= "no-bold"> using this Website in any way that impacts user access to this Website; </li>
	      				<li className= "no-bold"> using this Website contrary to applicable laws and regulations, or in a way that causes, or may cause, 
	      				harm to the Website, or to any person or business entity; </li>
	      				<li className= "no-bold"> engaging in any data mining, data harvesting, data extracting or any other similar activity in relation 
	      				to this Website, or while using this Website; </li>
	      				<li className= "no-bold"> using this Website to engage in any advertising or marketing; </li>
	      			</ol>
	      			Certain areas of this Website are restricted from access by you andLumiereVR may further
			...
			<li> Your Content.
				<p>
					...
					Content, by displaying it, you grant LumiereVR a non-exclusive, worldwide, irrevocable, royaltyfree,
					sublicensable license to use, reproduce, adapt, publish, translate and distribute it in any
					and all media.
				</p>

				<p>
					Your Content must be your own and must not be infringing on any third party’s
					rights.LumiereVR reserves the right to remove any of Your Content from this Website at any
			...
			<li> No warranties.
				<p>
					This Website is provided “as is,” with all faults, andLumiereVR makes no express or implied
			...
			<li> Limitation of liability.
				<p>
					In no event shall LumiereVR, nor any of its officers, directors and employees, be liable to you
					for anything arising out of or in any way connected with your use of this Website, whether such
					liability is under contract, tort or otherwise, and LumiereVR, including its officers, directors and
			...
			<li>  Indemnification.
				<p>
					You hereby indemnify to the fullest extentLumiereVR from and against any and all liabilities,
					costs, demands, causes of action, damages and expenses (including reasonable attorney’s
					fees) arising out of or in any way related to your breach of any of the provisions of these Terms.
				</p>
			</li>
			...
			<li> Variation of Terms.
				<p>
					LumiereVR is permitted to revise these Terms at any time as it sees fit, and by using this
			...
			<li> Assignment.
				<p>
					LumiereVR shall be permitted to assign, transfer, and subcontract its rights and/or obligations
			...
			<li> Entire Agreement.
				<p>
					...
					the entire agreement between LumiereVR and you in relation to your use of this Website, and
