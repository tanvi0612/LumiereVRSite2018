      ...
      <div className="container-fluid">
        ...
        <div className="case1TheaterWrapperDiv">
          <div className = "case1TheaterLeftDiv">
            <img className="colImg" src={require('../images/theaters/Case1TheaterRender.png')}/>
            <img className="colImg" src={require('../images/theaters/Case1TheaterDemo.png')}/>
          </div>
        ...
        <div className="case1TheaterBottomWrapperDiv">
          <div className="case1TheaterBottomLeftDiv">
            <img className="rowImg" src={require('../images/theaters/Case1Heatmap.png')}/>
          </div>
        ...
        <div className="case2TheaterWrapperDiv">
          ...
          <div className = "case2TheaterLeftDiv">
            <img className="colImg" src={require('../images/theaters/Case2TheaterDemo.png')}/>
            <img className="colImg" src={require('../images/theaters/Case2Setup.png')}/>
          </div>

          <div className = "case2TheaterRightDiv">
            <p>
              As a service to VR/Tech Conferences or Film Festivals, we’ve designed two software options instead of syncronous playback in order to account for crowd mob behaviour as well as optimizing throughput
              Costs are usually $6000-$8000 per event
            </p>
            <p>
              Option 1: <br></br>
              Software pro-programed via tablet to play designated film, user puts on headsets and film starts. User removes headset, film resets to the
              beginning.
            </p>
            <p>
              Option 2: <br></br>
              Headset is pre-programed to play disignated film at a certain time. Audience is lead in early and fitted with headsets that sit in a lobby
              screen until set time.
            </p>
            <p>
              For your events contact <a href= "mailto:theaters@lumierevr.com">theaters@lumierevr.com</a> for more details!
            </p>
            <p>
              Top Left: VR Fest by Jump Into The Light <br></br>
              Left: VIP Event for the Canadian Media Fund <br></br>
              Bottom: Gold Coast Motor Festival by JP Morgan <br></br>
            </p>
          </div>
        </div>
        ...
        <div className="case2TheaterBottomWrapperDiv">
          <div className="case2TheaterBottomLeftDiv ">
            <img className="rowImg" src={require('../images/theaters/Case2SitdownParty.png')}/>
          </div>

          <div className="case2TheaterBottomMidDiv ">
            <img className="rowImg" src={require('../images/theaters/Case2Lounge.png')}/>
          </div>

          <div className="case2TheaterBottomRightDiv ">
            <img className="rowImg" src={require('../images/theaters/Case2Badge.png')}/>
          </div>
        </div>
