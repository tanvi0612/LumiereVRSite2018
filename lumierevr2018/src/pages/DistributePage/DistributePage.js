  ...
  render() {
    return (
      <div className="container-fluid">
        ...
        <p align="center">
          Here are some case studies LumiereVR has undertaken involving the use
          of stand alone headsets and custom software systems.
        </p>
        <hr />
        <h1>Case 1</h1>
        ...
        <div className="case1TheaterWrapperDiv">
          ...
          <div className="case1TheaterRightDiv">
            <p>
              Partnering with the creators of The Click Effect as well as Zoos,
              Aquariums, and Museums we use a syncronized system of stand alone
              head-sets controlled by a master Tablet
            </p>
            <p>
        ...
        <div className="case2TheaterWrapperDiv">
          ...
          <div className="case2TheaterRightDiv">
            ...
            <p>
              ...
              time. Audience is lead in early and fitted with headsets that sit
              in a lobby screen until set time.
            </p>
            <p>
