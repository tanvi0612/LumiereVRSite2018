  ...
  render() {
    return (
      <div className="policy-page page">
        <div className="container no-limits first-section">
          <h4> LumiereVR Co PRIVACY POLICY </h4>
          <p>
            LumiereVR Co (the “Company”) is committed to maintaining robust
          ...
          <p>
            ...
            service which can be accessed via our website at www.lumierevr.com,
            in which users can browse our content and access our press kit The
            terms “we,” “us,” and “our” refer to the Company. “You” refers to
            you, as a user of Service. By accepting our Privacy Policy and Terms
            of Use (found here: the browsing party, you consent to our
          ...
          <p>
            ...
            demographic information we may collect, eferring/exit pages and
            ...
            Personal Information includes only your email, which you submit to
            us through the registration process at the Site.
          </p>
          <ol>
            <li>
              {" "}
              <i> Information collected via Technology </i>
              <p>
                To activate the Service you do not need to submit any Personal
                Information other than your email address. To use the rvice
              ...
              <p>
                ...
                registering, you are authorizing us to collect, tore and use
          ...
          <p>
            ...
            feedback from users, provide technical support, nd inform users
          ...
          <p>
            ...
            acquisition by another company, or sale of all or a ortion of our
            assets, your Personal Information may be among the assets
            transferred. You acknowledge and consent that uch transfers may
            ...
            practices. We suggest that you check the Site periodically if you
          ...
          <p>
            ...
            from otential security breaches by implementing certain
          ...
          <p>
            ...
            marketing purposes. When we send a promotional ommunication to a
            ...
            marketing communications from us in the “Settings” section of the
            Site. Please note that notwithstanding the promotional preferences
            you indicate by either unsubscribing or opting out in the Settings
            section of the Site, we may continue to send you administrative
          ...
          <p>
            ...
            specified in your account r by placing a prominent notice on our
          ...
          <b>Last Updated:</b> This Privacy Policy was last updated on Nov 6
          2017.
        </div>
      </div>
    );
